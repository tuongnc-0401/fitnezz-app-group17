...
--
-- Host: localhost:3306
-- Generation Time: Jan 25, 2021 at 04:56 AM
...
(21, 15, 20, 2, '2021-01-24', '12:04:46', 170, 60),
(22, 16, 26, 3, '2021-01-24', '17:47:16', 164, 70),
(23, 16, 26, 3, '2021-01-24', '17:47:25', 164, 70);
...
INSERT INTO `orders` (`order_id`, `user_id`, `date_order`, `time_order`, `address`, `phone_number`, `status`, `total`, `name_user`) VALUES
(19, 8, '01/24/2021', '6:01:17 PM', 'khong noi dau', '0989614688', 0, '90000', 'quochuy');
...
CREATE TABLE `order_details` (
  ...
  `sub_total` text NOT NULL COMMENT 'total cost of this product combo',
  `note` text,
...
INSERT INTO `order_details` (`detail_id`, `order_id`, `pro_id`, `quantity`, `sub_total`, `note`, `pro_name`) VALUES
(11, 19, 2, 1, '45000 ', 'hello', 'Breakfast 2'),
(12, 19, 1, 1, '45000 ', 'suon bi cha', 'Breakfast 1');
...
(15, 'huynguyen145', 's3825059@rmit.edu.vn', '$2y$10$IGVw1mFoSlFRNB0akwPdIe1iadyraVa5T/IdcXHLkte7493NfR/YC', 'male', NULL),
(16, 'quochuyhehe', 's3825059@rmit.edu.vn', '$2y$10$RZ7u2txujL0UVZs0hoM80uobS2kncE.9Uh7yqhOEfcP6LvfixbDqy', 'male', NULL);
...
--
ALTER TABLE `ibm`
  MODIFY `idBMI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `ingredients`
--
ALTER TABLE `ingredients`
  MODIFY `in_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
